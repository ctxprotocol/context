...
export const CheckIcon = ({ size = 16 }: { size?: number }) => (
  ...
  >
    <path
      clipRule="evenodd"
      d="M13.7803 4.21967L14.3107 4.75L13.25 5.81066L12.7197 5.28033L6.5 11.5607L3.28033 8.34099L2.75 7.81066L3.81066 6.75L4.34099 7.28033L6.5 9.43934L12.7197 3.21967L13.7803 4.21967Z"
      fill="currentColor"
      fillRule="evenodd"
    />
  </svg>
...
export const ChevronRightIcon = ({ size = 16 }: { size?: number }) => (
  ...
  >
    <path
      clipRule="evenodd"
      d="M6.75 12.0607L7.28033 11.5303L10.1036 8.7071C10.4941 8.31657 10.4941 7.68341 10.1036 7.29288L7.28033 4.46966L6.75 3.93933L5.68934 4.99999L6.21967 5.53032L8.68934 7.99999L6.21967 10.4697L5.68934 11L6.75 12.0607Z"
      fill="currentColor"
      fillRule="evenodd"
    />
  </svg>
...
export const WrenchIcon = ({ size = 16 }: { size?: number }) => {
  return (
    ...
    >
      <path
        clipRule="evenodd"
        d="M10.5 1C10.5 0.723858 10.7239 0.5 11 0.5C13.4853 0.5 15.5 2.51472 15.5 5C15.5 5.74028 15.3388 6.44238 15.051 7.07624L10.9237 2.94897C10.6403 2.66558 10.5 2.28342 10.5 1.89114V1ZM9.5 2.31058C9.5 2.10377 9.56607 1.90253 9.68934 1.73647C9.81261 1.57042 9.98622 1.44862 10.1861 1.38996C10.3859 1.3313 10.5998 1.33879 10.7952 1.41135C10.9905 1.48391 11.1572 1.61773 11.2703 1.79289L15.7071 6.22975C15.8823 6.40503 15.9877 6.63984 16.0043 6.88855C16.0208 7.13726 15.9473 7.38383 15.7976 7.58114C15.2573 8.30116 14.5678 8.90231 13.7733 9.34596C12.9788 9.78961 12.0977 10.0638 11.1859 10.1574L10.2529 11.0904C10.5027 11.6018 10.8127 12.2027 11.1872 12.8787C11.7103 13.8368 12.332 14.9476 13.0607 16.2097L13.1465 16.3599L12.9929 16.4457C11.7309 17.1744 10.6201 17.7961 9.66197 18.3192C8.98591 18.6937 8.38503 19.0037 7.87361 19.2535L7.07107 18.4509C6.38803 17.7679 5.43617 17.4108 4.46799 17.4724C3.49982 17.534 2.60009 18.0078 2.00365 18.7726L1.29289 19.6569L0.585786 18.9497C0.0736101 18.4376 -0.191675 17.7231 0.128681 17.0748C0.449037 16.4265 1.19098 16.0158 1.89645 16.0158C2.60192 16.0158 3.34387 15.605 3.66422 14.9567C3.98458 14.3085 3.71929 13.594 3.20711 13.0818L1.22183 11.0965C1.34271 10.7589 1.48687 10.3869 1.65623 9.98591C2.17937 8.68803 2.95617 6.93617 4.04052 4.85761L4.18934 4.60355L4.44339 4.75237C5.70552 5.48107 6.81629 6.10278 7.77447 6.62595C8.45053 7.00038 9.05141 7.31037 9.56283 7.56021L10.4958 6.62723C10.4173 5.66838 10.6632 4.70698 11.1939 3.89894C11.7246 3.09089 12.5118 2.47985 13.4283 2.16006C13.5937 2.10253 13.7455 2.01127 13.8743 1.89249C14.0031 1.77371 14.1062 1.62993 14.1777 1.47002C14.2492 1.31012 14.2876 1.13761 14.2907 0.962551C14.2938 0.787494 14.2614 0.613724 14.1957 0.451456C13.4757 -1.03387 11.6141 -1.53387 10.1303 0.451456C10.0615 0.549091 10.014 0.660486 9.99078 0.778257C9.96758 0.896029 9.97005 1.01746 9.99805 1.13405C10.026 1.25065 10.0789 1.3598 10.1531 1.45397C10.2273 1.54814 10.321 1.62509 10.4275 1.67968L11.0607 2L10.5607 2.5L10.2275 2.16718C10.1324 2.07214 10.0186 1.99765 9.89353 1.94833C9.76846 1.89901 9.63446 1.87594 9.5 1.88058V2.31058ZM3.06066 12.9393C2.47487 12.3536 1.47487 12.3536 0.889087 12.9393L0.182024 13.6464L1.59624 15.0606L2.30329 14.3536C2.88908 13.7678 2.88908 12.7678 2.30329 12.182L3.06066 12.9393Z"
        fill="currentColor"
        fillRule="evenodd"
      />
    </svg>
...
export const LayersIcon = ({ size = 16 }: { size?: number }) => {
  return (
    ...
    >
      <path
        clipRule="evenodd"
        d="M7.65197 0.741546C7.86869 0.622813 8.13131 0.622813 8.34803 0.741546L15.348 4.74155C15.6003 4.88128 15.75 5.15039 15.75 5.44118C15.75 5.73196 15.6003 6.00107 15.348 6.14081L8.34803 10.1408C8.13131 10.2595 7.86869 10.2595 7.65197 10.1408L0.65197 6.14081C0.399727 6.00107 0.25 5.73196 0.25 5.44118C0.25 5.15039 0.399727 4.88128 0.65197 4.74155L7.65197 0.741546ZM2.45098 5.44118L8 8.66407L13.549 5.44118L8 2.21829L2.45098 5.44118ZM15.348 9.14081C15.6003 9.00107 15.75 8.73196 15.75 8.44118C15.75 8.15039 15.6003 7.88128 15.348 7.74155L14.25 7.12647V8.94525L13.549 9.34131L8 12.5642L2.45098 9.34131L1.75 8.94525V7.12647L0.65197 7.74155C0.399727 7.88128 0.25 8.15039 0.25 8.44118C0.25 8.73196 0.399727 9.00107 0.65197 9.14081L7.65197 13.1408C7.86869 13.2595 8.13131 13.2595 8.34803 13.1408L15.348 9.14081ZM14.25 10.1265L15.348 10.7415C15.6003 10.8813 15.75 11.1504 15.75 11.4412C15.75 11.732 15.6003 12.0011 15.348 12.1408L8.34803 16.1408C8.13131 16.2595 7.86869 16.2595 7.65197 16.1408L0.65197 12.1408C0.399727 12.0011 0.25 11.732 0.25 11.4412C0.25 11.1504 0.399727 10.8813 0.65197 10.7415L1.75 10.1265V11.9453L2.45098 12.3413L8 15.5642L13.549 12.3413L14.25 11.9453V10.1265Z"
        fill="currentColor"
        fillRule="evenodd"
      />
    </svg>
